...
public class Validacoes {
    ...
    public static String mensagemErroNome(String nome) {
        ...
        if (nome == null || nome.trim().isEmpty()) {
            return "Erro: O nome do lobo não pode estar vazio!";
        // Verifica se o nome contém números usando regex
        } else if (nome.matches(".*\\d+.*")) {
            return "Erro: O nome do lobo não pode conter números!";
        }
    ...
    public static String mensagemErroIdade(int idade) {
        ...
        if (idade < 0) {
            return "Erro: A idade do lobo não pode ser negativa!";
    ...
    public static String mensagemErroAltura(double altura) {
        ...
        if (altura < 0.8) {
            return "Erro: Altura do lobo é muito baixa!";
        // Verifica se a altura excede o limite máximo
        } else if (altura > 0.85) {
            return "Erro: Altura do lobo é inválida!";
        }
